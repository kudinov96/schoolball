!function i(o, r, s) {
        ...
        function v(t, e, n, i) {
            ...
            e ? (e[I]("data-inject-url", n), (o = t.parentNode) && (i.copyAttributes && function (t, e) {
                for (var n = t.attributes, i = 0; i < n[A]; i++) {
                    var o, r, s, a = (s = n[i]).name;
                    -1 == p.indexOf(a) && (r = s.value, a == l ? ((s = e.firstElementChild) && s.localName.toLowerCase() == l ? o = s : (o = d[h + "NS"]("http://www.w3.org/2000/svg", l), e.insertBefore(o, s)), o.textContent = r) : e[I](a, r))
                }
                ...
                t = function () {
                    ...
                    function K() {
                        ...
                        (et = 0 < arguments.length && void 0 !== arguments[0] && arguments[0] ? !0 : et) && (s = nt, (t = tt).forEach(function (t, e) {
                            ...
                            s.initClassName && t.node.classList.add(s.initClassName), t.position = {
                                in: function (t, e, n) {
    ...
    3: [function (t, e, n) {
        ...
        c = function () {
            ...
            function Ke(n, t, e, i) {
                var o, r, s,
                    t = "clippingParents" === t ? (r = Ue(Ie(o = n)), me(s = 0 <= ["absolute", "fixed"].indexOf(Te(o).position) && ge(o) ? Le(o) : o) ? r.filter(function (t) {
                    ...
                    return jo(l, [{
                        ...
                        value: function () {
                            if (!a(this._element) && !this._isShown()) {
                                ...
                                if (!M.trigger(this._element, Xe, e).defaultPrevented) {
                                    if (this._createPopper(), "ontouchstart" in document.documentElement && !this._parent.closest(".navbar-nav")) {
                                        var t, n, i = vi((t = []).concat.apply(t, oi(document.body.children)));
                                        try {
                                            for (i.s(); !(n = i.n()).done;) {
                                                var r = n.value;
                                                M.on(r, "mouseover", u)
                                    ...
                                    this._element.focus(), this._element.setAttribute("aria-expanded", !0), this._menu.classList.add(Je), this._element.classList.add(Je), M.trigger(this._element, Qe, e)
                                }
                            }
                        }
                    }, {
            ...
            var O = (t(tt, [{
                ...
                K = (t(J, [{
                    ...
                    value: function () {
                        ...
                        var s, i, o, r, a, l, c, u, d, h, f, p, m, g, y, v, b, _, w, x, k, S, E, A, T, C, I, O, L,
                            e = document.body,
                    ...
                    value: function () {
                        var t, e, n, i, o, r, s, a, l,
                            c = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : null;
    ...
    17: [function (t, e, O) {
        !function (I) {
            !function () {
                ...
                var e, p, n,
                    m = "undefined" != typeof window ? window : void 0 !== I ? I : "undefined" != typeof self ? self : {},
                    d = m.navigator,
                ...
                var _ = 0,
                    ...
                    T = function () {
                        ...
                        return t(i, [{
                            ...
                            value: function (t) {
                                var e, n, i, o, r,
                                    s = !(!(e = (e = t).match(/.*(?:youtu.be\/|v\/|u\/\w\/|embed\/|watch\?v=)([^#\&\?]*).*/)) || 11 !== e[1].length) && e[1],
        ...
        o = window, r = function (t, e) {
            ...
            t.constructor = a, t._create = function () {
                ...
                var t = getComputedStyle(this.element),
                    ...
                    s = parseFloat(o),
                    t = this.layout.size;
                -1 != i.indexOf("%") && (r = r / 100 * t.width), -1 != o.indexOf("%") && (s = s / 100 * t.height), r = isNaN(r) ? 0 : r, s = isNaN(s) ? 0 : s, r -= e ? t.paddingLeft : t.paddingRight, s -= n ? t.paddingTop : t.paddingBottom, this.position.x = r, this.position.y = s

...
">
                    <a href="https://schoolball.ru/weekend">
                        <img  src="{{ asset('assets/images/logo@4x.png')}}" style="width: 40%; margin: 0 0px;top: -14px; position: relative;">                    </a>
                </div>
        ...
        <div class="mainHeader">
            <div class="row">
                ...
                <div class="col-md-1 mainHeaderLogo text-center">
                    ...
                    <img  src="{{ asset('assets/images/logo@4x.png')}}" style="    width: 80%;
    margin: 0 20px;
    margin-top: 1px;">        </a>
...
<div class="footer d-none d-md-block" style="overflow: hidden; margin-bottom: 45px; ">
    <div class="container">
        <div class="row">
            <div class="col-md-5 text-left">
...
">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="col-md-12 footerLinks">
                                    <h5><a style="font-size: 18px;  color: #fff; " href="#clubs">Клубы</a></h5>
                                </div>
        ...
        <div class="modal-content">
            ...
            <div id="callback-1-front">
                <div class="modal-body text-center">
                    <div class="row">
                        <div class="col-md-12">
                            <img  src="{{ asset('assets/images/logo@4x.png')}}" style="width: 20%; margin: 0 0px;top: -14px; position: relative;">
                        </div>
                    </div>
                    <form id="sendform" method="post">
                        @csrf

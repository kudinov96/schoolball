...
<html lang="en">
  <head>
    ...
    <meta name="csrf-token" content="{{ csrf_token() }}" />
      <link href="https://fonts.googleapis.com/css2?family=Montserrat+Alternates:wght@300;400;500;700;800&display=swap" rel="stylesheet">
      <meta property="og:title" content="Мы научим вашего ребёнка играть в футбол." />
    <meta property="og:type" content="favicon-32x32.png" />
    <meta property="og:url" content="https://schoolball.ru/camp" />
    <meta property="og:image" content="{{ asset('assets/icon-32x32.png') }}" />
    <meta property="og:description" content="Мы научим вашего ребёнка играть в футбол.">
    <!-- Bootstrap CSS -->
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('assets/icon-32x32.png') }}">
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('assets/icon-16x16.png') }}">
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('assets/icon-32x32.png') }}">
    <title>Летний футбольный лагерь</title>

    <script type="text/javascript" src="https://cdn.jsdelivr.net/jquery/latest/jquery.min.js"></script>
    <script type="text/javascript" src="{{ asset('css/bootstrap-4.5.0-dist/js/bootstrap.min.js') }}"></script>
	...
	})(window,document,'script','dataLayer','GTM-MJ7BV4G');</script>
  ...
  <script type="text/javascript">
    !function(){var t=document.createElement("script");t.type="text/javascript",t.async=!0,t.src='https://vk.com/js/api/openapi.js?169',t.onload=function(){
      VK.Retargeting.Init("VK-RTRG-1395298-bznpk"),VK.Retargeting.Hit()},document.head.appendChild(t)}();
  </script>
  <noscript><img src="https://vk.com/rtrg?p=VK-RTRG-1395298-bznpk" style="position:fixed; left:-999px;" alt=""/></noscript>


  </head>
  <body>
  	<!-- Google Tag Manager (noscript) -->
	<noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-MJ7BV4G"
	height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
	<!-- End Google Tag Manager (noscript) -->

    <div class="d-sm-block d-md-none" style="overflow:hidden;width:100%;">
      <div class="mobile-header">
       <?php /* <div class="topOfHeader" style="">
          <div class="row">
            <div class="col-4">
                <iframe style=""  src="https://yandex.ru/sprav/widget/rating-badge/210252513599" width="150" height="50" frameborder="0"></iframe>
            </div>
            <div class="col-6 offset-2 header-telephone text-right">
              <h4 style="font-size: 12px;margin-top: 12px;margin-right: 12px;"><a href="tel:+74951206006" style=" color: #303337;" onclick="fbq('track', 'Contact');ym(75176041,'reachGoal','Contact')">+7 (495) 120-60-06</a></h4>
            </div>
          </div>
        </div>
 */ ?>
        <div class="bottomOfHeader">
          <div class="row">
            <div class="col-3 text-center mobileHeaderlogo" style="margin-right: -15px;">
              <a href="https://schoolball.ru/camp">
                <a href="https://schoolball.ru/camp">
                  <img  src="{{ asset('assets/images/camp/logo.png')}}" style="width: 100%; margin: 0 0px;top: -7px; position: relative;">
                </a>
              </a>
            </div>
            ...
            <div class="col-2 menuButton" style="margin-right: -10px;">
              <!-- <i class="fas fa-bars" id="mobMenuTog" style="font-size: 20px;margin: 6px 16px;"></i> -->
              <a href="tel:+74992885448" id="" style="
              margin-bottom: 0.5rem; text-align: center!important;
    font-weight: 500; margin-top: 0; font-family: Montserrat Alternates;font-size: 20px;padding: 5px;margin-right: 5px;border-radius: 4px;border: solid 1px #fec311;background-color: #fec311;height: 32px;color: #54420a; width: 32px;">
              ...
              <div class="col-2 menuButton">
                  <!-- <i class="fas fa-bars" id="mobMenuTog" style="font-size: 20px;margin: 6px 16px;"></i> -->
                  <h3 id="mobMenuTog" style="font-family: Montserrat Alternates;font-size: 20px;line-height: 20px;padding: 5px;margin-right: 5px;border-radius: 4px;border: solid 1px #fec311;background-color: #fec311;height: 32px;color: #54420a; width: 32px;"><i class="fa fa-bars" aria-hidden="true"></i>
                  </h3>
              </div>
          </div>
        </div>
      </div>
      <div id="mobMenu" class="mobMenu d-none" style="overflow: auto;">
        <div class="mobMenuButtons">
          <h4 style="text-align: left!important;margin: 0px 15px 15px 15px;font-size: 25px;font-family: Montserrat Alternates;">Ул. Плющиха 57а (м. Киевская):</h4>
          <a onclick="showMenuContent()" href="/camp/cao#campProgramm">Программа лагеря</a>
          <a onclick="showMenuContent()" href="/camp/cao#grafikSmen">График смен</a>
          <a onclick="showMenuContent()" href="/camp/cao#schedule">Распорядок дня</a>
          <a onclick="showMenuContent()" href="/camp/cao#prices">Стоимость</a>
        </div>
        <div class="mobMenuLC">
          <h4 style="text-align: left!important;margin: 0px 15px 15px 0px;font-size: 25px;font-family: Montserrat Alternates;">Ул. Академика Скрябина 23 стр. 2 (м. Кузьминки):</h4>
          <a onclick="showMenuContent()" href="/camp/uvao#campProgramm">Программа лагеря</a><br><br>
          <a onclick="showMenuContent()" href="/camp/uvao#grafikSmen">График смен</a><br><br>
          <a onclick="showMenuContent()" href="/camp/uvao#schedule">Распорядок дня</a><br><br>
          <a onclick="showMenuContent()" href="/camp/uvao#prices">Стоимость</a>
        </div>
        <div class="mobMenuLC">
          <h4 style="text-align: left!important;margin: 0px 15px 15px 0px;font-size: 25px;font-family: Montserrat Alternates;">ПОДМОСКОВЬЕ:</h4>
          <a onclick="showMenuContent()" href="/camp/undermos#campProgramm">Программа лагеря</a><br><br>
          <a onclick="showMenuContent()" href="/camp/undermos#grafikSmen">График смен</a><br><br>
          <a onclick="showMenuContent()" href="/camp/undermos#schedule">Распорядок дня</a><br><br>
          <a onclick="showMenuContent()" href="/camp/undermos#prices">Стоимость</a>
        </div>
        <!-- <div class="mobMenuLC">
          <a href="https://schoolball.ru/news"><h4 style="text-align: left!important;margin: 0px 15px 15px 0px;font-size: 25px;font-family: Montserrat Alternates;">НОВОСТИ</h4></a>
        </div> -->
      </div>
    </div>
    ...
    <div id="app" class="d-none d-md-block">
        ...
        <div class="container-fluid" style="position: fixed;top: 0px;height: 130px;z-index: 100;background: #f7f7f9; border-bottom-right-radius: 2000px 200px;
    border-bottom-left-radius: 2000px 200px;">
          <div class="topHeader">
            <div class="row">
              <div class="col-md-3 text-center topHeaderLocation">
                <h4>Летний лагерь в <a href="https://schoolball.ru/camp/#map">Москве и МО</a></h4>
              </div>
              <div class="col-md-3 text-center topHeaderYandexRatio">
                <div class="row">
                    <!--
                  <div class="col-md-7 text-right topHeaderYandexReview">
                    <p>Cредняя оценка клиентов</p>
                  </div>
                  <div class="col-md-1 yandexStars" style="margin-top: -4px;">
                    <span style="font-size: 13px;color:#fec311; margin-top: -3px;">4.7 </span>
                  </div>
                  <div class="col-md-3">
                    <img src="{{ asset('assets/Group 19.png') }}" alt="" style="width: 75px; ">
                  </div>
                </div>
                !-->


                    <div class="col-md-7 offset-4 text-center">
                       <iframe  src="https://yandex.ru/sprav/widget/rating-badge/210252513599" width="150" height="50" frameborder="0"></iframe>
                    </div>
                </div>
              </div>
              <div class="col-md-3 text-center topHeaderTelephone">
                <h4><a href="tel:+74951206006" style=" color: #000;" onclick="fbq('track', 'Contact');ym(75176041,'reachGoal','Contact')">+7 (495) 120-60-06</a></h4>
              </div>
              <div class="col-md-3 text-center topHeaderWorkingTime">
                <h4>Ежедневно с 10:00 до 20:00</h4>
              </div>
            </div>
          </div>
          <div class="mainHeader">
            <div class="row">
              <div class="col-md-1 mainHeaderLogo text-center">
                <a href="{{ URL::to('/camp') }}">
                  <img src="{{ asset('assets/images/camp/logo.png')}}" style="width: 100%; margin: 0 20px;">
                </a>
              </div>
              <div class="col-md-7" style="padding-left: 30px;">
                <div class="row">
                  <div class="col-auto text-center mainHeaderMenu">
                    <h3><a href="{{ route('district', ['district' => 'cao']) }}">метро КИЕВСКАЯ</a></h3>
                  </div>
                  <!-- <div class="col-auto text-center mainHeaderMenu" >
                    <h3><a href="{{ route('district', ['district' => 'zao']) }}">ЗАПАДНЫЙ ОКРУГ</a></h3>
                  </div> -->
                  <div class="col-auto text-center mainHeaderMenu">
                    <h3><a href="{{ route('district', ['district' => 'uvao']) }}">метро КУЗЬМИНКИ</a></h3>
                  </div>
                  <!-- <div class="col-auto text-center mainHeaderMenu">
                    <h3><a href="https://schoolball.ru/news">НОВОСТИ</a></h3>
                  </div> -->
                  <div class="col-auto text-center mainHeaderMenu">
                    <h3><a href="{{ route('district', ['district' => 'undermos']) }}">ПОДМОСКОВЬЕ</a></h3>
                  </div>
                </div>
              </div>
              <div class="col-md-4 text-right" style="padding-right: 25px;">
                ...
                <button type="button" name="button" class="mainHeaderButtonFix" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg" style="width: 75%;">Записаться на экскурсию</button>
                </div>
            </div>
          </div>
        </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-5 text-left">
              <h4>Остались вопросы? Звоните:</h3>
              <a href="tel:+74951206006" style=" color: #FFF;" onclick="fbq('track', 'Contact');ym(75176041,'reachGoal','Contact')"><h3>+7 (495) 120-60-06</h3></a>
              <h5>Ежедневно с 10:00 до 20:00</h5>
              <h6><a href="mailto:info@school-ball.com">info@school-ball.com</a></h6>
              <h5 class="d-none d-md-block">Ежедневно с 10:00 до 20:00</h5>
              <p>Присоединяйтесь к нам в соцсетях, чтобы быть в курсе событий школы</p>
              <div class="row">
                <div class="col-md-2 col-3 socialLinks">
                  <!-- <img src="{{ asset('assets/vk 2.png') }}" alt=""> -->
                  <a href="https://vk.com/school_ball_industry" onclick="fbq('track', 'ViewContent');ym(75176041,'reachGoal','ViewContent')"><i class="fab fa-vk" style="color: cornflowerblue;font-size: 30px;"></i></a>
                </div>
                <!-- <div class="col-md-2 col-3 socialLinks">
                  <img src="{{ asset('assets/facebook 2.png') }}" alt="">
                  <a href="https://www.facebook.com/schoolballindustry" onclick="fbq('track', 'ViewContent');ym(75176041,'reachGoal','ViewContent')"><i class="fab fa-facebook" style="font-size: 30px;"></i></a>
                </div>
                <div class="col-md-2 col-3 socialLinks">
                  <img src="{{ asset('assets/instagram 2.png') }}" alt="">
                  <a href="https://www.instagram.com/schoolball_industry/" onclick="fbq('track', 'ViewContent');ym(75176041,'reachGoal','ViewContent')"><i class="fab fa-instagram" style="font-size: 30px;color: #a82e9c;"></i></a>
                </div> -->
                <div class="col-md-2 col-3 socialLinks">
                  <!-- <img src="{{ asset('assets/youtube.png') }}" alt=""> -->
                  <a href="https://www.youtube.com/channel/UCIlhhba-lmo0je2HtE-Ak4w" onclick="fbq('track', 'ViewContent');ym(75176041,'reachGoal','ViewContent')" target="_blank"><i class="fab fa-youtube" style="font-size: 30px;color: #ff0100;"></i></a>
                </div>
              </div>
            </div>
            <div class="col-md-6 offset-1 text-left d-none d-md-block">
              <div class="row">
                <div class="col-md-8 offset-1">
                  <div class="row">
                    <div class="col-12">
                      <h5>Локации Летнего лагеря</h5>
                    </div>

                      <div class="col-md-6 footerLinks">
                        <a href="{{ route('district', ['district' => 'cao']) }}"><h5>Центральный</h5></a>
                      </div>
                      <div class="col-md-6 footerLinks">
                        <a href="{{ route('district', ['district' => 'uvao']) }}"><h5>Юго-восточный</h5></a>
                      </div>
                      <div class="col-md-6 footerLinks">
                        <a href="{{ route('district', ['district' => 'undermos']) }}"><h5>Подмосковье</h5></a>
                      </div>
                      <!-- <div class="col-md-6 footerLinks">
                        <h5>Западный</a></h5>
                      </div> -->
                ...
                <div class="col-md-12 text-left">
                  <div class="footerPersonalData">
                    <h6>Индивидуальный предприниматель Хольнов Дмитрий Сергеевич<br>Адрес: 121609, Москва, Рублевское шоссе д. 38 корп. 2 кв. 207. </br>ИНН 773102940059 | ОГРН ИП 318774600373029 </h6>
                  </div>
                  <div class="footerPersonalData">
                    <h6>Индивидуальный предприниматель Вершинин Андрей Андреевич<br>Адрес: 111675, Москва, ул.Татьяны Макаровой д. 8, кв. 53. </br>ИНН 772084866760 | ОГРН ИП 318774600205069 </h6>
                  </div>
                  <div class="footerPersonalData">
                    <h6>Общество с ограниченной ответственностью «Школа мяча плюс»<br>Адрес:121087,г.Москва,ул.ФилёвскаяБ., д. 4, пом. 163 </br>ИНН 7707407900 | КПП 770701001</br>Банк: АО «АЛЬФА-БАНК», г. Москва р/с 40702810702390003476 кор/сч 30101810200000000593 БИК 044525593 </br>
                      Взаимодействуя с сайтом и используя формы обратной связи, вы даёте согласие на обработку  персональных данных и соглашаетесь с <a style="font-size: 14px;" href="https://schoolball.ru/assets/doc/politic.pdf" target="_blank">политикой конфиденциальных данных</a></h6>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="modal-dialog modal-lg">
              <div class="modal-content">
                  <div class="modal-header text-center">
                      <h5 class="modal-title mt-0" id="myLargeModalLabel"style="font-family: Montserrat Alternates;">Оставить заявку</h5>
                    ...
                    <div class="modal-body text-center">
                      ...
                      <form id="sendform" method="post">
                        ...
                        <div class="row">
                          ...
                          <div class="col-1 text-left"><p style="text-align: left;color: red;font-size:20px;">*</p></div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row"><div class="col-md-8 col-sm-12 text-center"><p style="color: red;height: auto;margin: 0;font-size:20px;">* Поля для обязательного заполнения</p></div></div>
                        <hr>
                        <div class="row">
                        ...
                        <div class="row">
                          <label for="district" class="col-md-4 col-form-label-new text-md-right">Локация:</label>
                          <div class="col-md-6">
                            <select id="f_loc" class="form-control-new" name="district" style="margin-bottom: .5rem;" onchange="time_select(this.value)" required>
                        ...
                        <div class="row" id="smenaSelect_place" style="visibility: hidden;">
                          <label for="time" class="col-md-4 col-form-label-new text-md-right">Смена:</label>
                          <div class="col-md-6">
                            <select id="smenaSelect"  class="form-control-new" name="time" style="margin-bottom: .5rem;">
                              <option value="0">Не выбрано</option>
                                ...
                                <option value="7">7 смена</option>
                            </select>
                          </div>
                        </div>
                      </form>
                    </div>
                    <div id="submitarea" class="modal-footer text-center d-none">
                      <div class="sogl">
                        <input id="sogl" type="checkbox" name="sogl" onchange="checkButton()">
                        ...
                        <label id="sogl-2"for="sogl">Я согласен на <a href="{{ asset('assets/doc/sogl-ip_vaa.pdf')}}" target='_blank'>обработку персональных данных</a></label>
                        <label id="sogl-3"for="sogl">Я согласен на <a href="{{ asset('assets/doc/sogl-ip_vaa.pdf')}}" target='_blank'>обработку персональных данных</a></label>
                      </div>
                      <button id="sogl-btn" type="submit" class="btn btn-primary waves-effect waves-light" style="margin: 0 auto; color: #54420a; background-color: #fede11; border: solid 1px #fede11; box-shadow: none;" onclick="sendForm()" disabled>Отправить заявку</button>
                    </div>
                  </div>
    ...
    <div class="socialIcons">
        <button class="socialIcons__item popupOpen"  data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">
            <svg>
                <use xlink:href="{{ asset('assets/icons/sprite-mono.svg#phone') }}">
            </svg>
        </button>
    ...
    <!-- /.modal -->
      <script>
        function sendForm() {
          if ($("#sendform")[0][1].value !== '' && $("#sendform")[0][2].value !== '') {
            $.ajax({
                type: "POST",
                url: "{{ route('sendCampInfo') }}",
            ...
            ym(75176041,'reachGoal','SubmitApplication')
          } else {
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@4.6.0/dist/js/bootstrap.bundle.min.js" integrity="sha384-Piv4xVNRyMGpqkS2by6br4gNJ7DXjqk09RmUpJ8jgGtD7zP9yug3goQfGII0yAns" crossorigin="anonymous"></script>    <script src="https://ajax.googleapis.com/ajax/libs/jquery/2.0.3/jquery.min.js"></script>

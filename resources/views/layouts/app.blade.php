...
<div class="d-sm-block d-md-none" style="overflow:hidden;width:100%;">
    ...
    margin: 0px 12px 1px -16px !important;
">
                    <a href="https://schoolball.ru/#">
                        <svg width="80px" height="38px" viewBox="0 0 80 56" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <defs>
    ...
    border-bottom-left-radius: 2000px 200px;">
        ...
        <div class="mainHeader">
            <div class="row">
                ...
                <div class="col-md-1 mainHeaderLogo text-center">
                    <a href="{{ URL::to('/') }}">
                        <img src="{{ asset('assets/school-ball-logo-rus-3.svg')}}" style="width: 90%;
    margin: 0 20px;
    margin-top: 6px;">
                    </a>
                </div>
...
*/ ?>
 ...
 <!-- Modal Заявка на тренировку form -->
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div id="callback-1-front">
                <div class="modal-body text-left">
                    <h5 class="modal-title2 mt-0"  id="myLargeModalLabel">Заполните форму, чтобы записаться на тренировку
                    </h5>
    ...
    height: AUTO;
">
                        Запишитесь на открытый урок, а мы перезвоним и проконсультируем.
                    </p>
...
<div class="modal fade bs-example-modal-lg2" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div id="sendpsychologist-1-front">

                <div class="modal-body text-left">
                    <h5 class="modal-title2 mt-0"  id="myLargeModalLabel">Введите данные, чтобы скачать рекомендации
                    </h5>
                    ...
                    <div class="">
                        ...
                        <form id="sendpsychologist" method="post" class="needs-validation" novalidate>
                            @csrf
                            <div class="row">
                                <div class="col-md-12 col-xl-12  ">
                                    <div class="form-floating mb-3">
                            ...
                            <div class="row">
                                <div class="col-md-6 col-xl-6">
                                    <button class="btn btn-primary" style="margin-top: 24px !important;" type="submit" onclick="sendPsychologist(event)">Отправить заявку</button>
                                </div>
                            </div>
                ...
                <div class="modal-body text-center" style="margin: 32px;">
                    <div  >
                        ...
                        <div class="col-md-12">
                            ...
                            <p class="psy-about">Рекомендации от нашего психолого уже скачиваются на ваше устройство. </p><br>

                            <a href="#" data-dismiss="modal" aria-hidden="true"  class="btn btn-primary" style="    margin-top: 0px !important;
    margin-bottom: 56px !important;
    width: 100% !important;">Закрыть</a>
...
<!-- /.modal -->
        ...
        <script>
            ...
            function sendPsychologist(event) {
                event.preventDefault();
                var form = $("#sendpsychologist")[0];

                if (form.checkValidity() && form[1].value !== '' && form[2].value !== '') {
...
<script src="https://kit.fontawesome.com/986c39d78b.js" crossorigin="anonymous"></script>

...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/style_lager.css') }}">
...
<div class="d-sm-block d-md-none" style="overflow:hidden;width:100%;">
    <div class="   mobile-header">
        <div class="header-mob block-mob topOfHeader">
            <div class="row">

                <div class="col-9 offset-4 header-telephone text-right">
                    <h4 style="margin-top: 12px;margin-right: 12px;font-size:14px;"><a href="tel:+74951206006" style=" color: #303337;">+7 (495) 120-60-06</a></h4>
                </div>
            </div>
        ...
        <div class="bottomOfHeader">
            <div class="row">
                <div class="col-5 text-center mobileHeaderlogo" style="
    margin: 0px 10px 0px -16px;
">
                    <a href="#">
                        <img   class="logo_lager" src="{{ asset('assets/images/camp/logo.png')}}"  >                    </a>
                </div>
                ...
                <div class="col-2 menuButton">
                    <i class="fas fa-bars" id="mobMenuTog" style="font-size: 20px;margin: 5px 0px;"></i>
                </div>
            </div>
        </div>
    </div>
    ...
    /* border-bottom-left-radius: 2000px 200px;">
        ...
        <div class="mainHeader">
            <div class="row">
                ...
                <div class="col-md-1 mainHeaderLogo text-center">
                    <a href="{{ URL::to('/') }}">
                        <img src="{{ asset('assets/images/camp/logo.png')}}" style="width: 90%;
    margin: 0 20px;
    margin-top: 6px;">
                    </a>
                </div>
                ...
                <div class="col-md-7" style="padding-left: 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto text-center mainHeaderMenu" >
                            <h3><a href="{{ request()->is(['catalog', 'blog', 'clubs']) ? '/home#methods' : '#methods' }}">МЕТОДИКА</a></h3>
                        </div>
                        <div class="col-auto text-center mainHeaderMenu" >
                            <h3><a href="{{ request()->is(['catalog', 'blog', 'clubs']) ? '/home#coaches' : '#coaches' }}">ТРЕНЕРЫ</a></h3>
                        </div>
                        <div class="col-auto text-center mainHeaderMenu">
                        ...
                        <div class="col-auto text-center mainHeaderMenu">
                            <h3><a href="{{ request()->is(['catalog', 'blog', 'clubs']) ? '/home#reviews' : '#reviews' }}">ОТЗЫВЫ</a></h3>
                        </div>
                        <div class="col-auto text-center mainHeaderMenu">
 ...
 */
                    ...
                    <button type="button" name="button" class="mainHeaderButtonFix" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Оставить заявку</button>
                </div>
...
">
                    ...
                    <a style="font-size: 16px;  color: #fff; "  href="/politika-konfidencialnosti" target='_blank'>Политика конфиденциальности</a> <br>
                    <a style="font-size: 16px;  color: #fff; " href="/soglasie-na-obrabotku-personalnyh-dannyh" target='_blank'>Соглашение на обработку персональных данных </a><br>
                    <a style="font-size: 16px;  color: #fff; " href="/polzovatelskoe-soglasenie" target='_blank'>Пользовательское соглашение</a>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5 text-left">
                ...
                <div class=" ">
                    <div class=" ">
                        <h5><a style="font-size: 16px;  color: #fff; "  href="/politika-konfidencialnosti" target='_blank'>Политика конфиденциальности</a></h5>
                    </div>

                    <div class=" ">
                        <h5><a style="font-size: 16px;  color: #fff; " href="/soglasie-na-obrabotku-personalnyh-dannyh" target='_blank'>Соглашение на обработку персональных данных </a></h5>
                    </div>


                    <div class=" ">
                        <h5><a style="font-size: 16px;  color: #fff; " href="/polzovatelskoe-soglasenie" target='_blank'>Пользовательское соглашение</a></h5>
                    </div>
                </div>
            </div>
...
<div class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h5 class="modal-title mt-0" id="myLargeModalLabel">Оставить заявку</h5>
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true" style="color: #343a40;width: unset;height: unset;background: unset;border: unset;font-size: 1.5rem;line-height: 1;">×</button>
            </div>
            <div id="callback-1-front">
                <div class="modal-body text-center">
 ...
 <img src="{{ asset('assets/images/camp/logo.png')}}" class="mb-5"   width="200px" style="width:200px;">

...
">
                    <a href="https://schoolball.ru/camp2">
                        <img   src="{{ asset('assets/images/camp/logo.png')}}" style="width: 40%; margin: 0 0px;top: -15px; position: relative;">                    </a>
                </div>
    ...
    <div id="mobMenu" class="mobMenu d-none">
        <div class="mobMenuButtons">
            <a onclick="showMenuContent()" href="#aboutmob">О ЛАГЕРЕ</a>
            <a onclick="showMenuContent()"  href="#programamob">ПРОГРАММА</a>
            <a onclick="showMenuContent()"  href="#schedulemob">РАСПИСАНИЕ</a>
            <a onclick="showMenuContent()" href="#reviewsmob">ОТЗЫВЫ</a>
            <a onclick="showMenuContent()" href="#reviewsmob">СТОИМОСТЬ</a>
                ...
                <div class="col-md-7" style="padding-left: 30px;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-auto text-center mainHeaderMenu" >
                            <h3><a href="#about">О ЛАГЕРЕ</a></h3>
                        </div>
                        <div class="col-auto text-center mainHeaderMenu" >
                            <h3><a href="#program">ПРОГРАММА</a></h3>
                        </div>
                        <div class="col-auto text-center mainHeaderMenu">
                        ...
                        <div class="col-auto text-center mainHeaderMenu">
                            <h3><a href="#price">СТОИМОСТЬ</a></h3>
                        </div>
                    </div>

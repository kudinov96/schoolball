<div class="seventhSection"  style="margin-top: 50px; margin-bottom: 48px;">
    <div class="container">
        <div class="mobSeventhSection col-md-12 text-center d-none d-md-block">
            <h3 class="title-desc" style=" margin-bottom: 35px !important;">Место проведения футбольных выходных</h3>
            <h5 class="text-desc " style="font-size: 20px; ">
                Спортивная база расположена в 70 минутах от Москвы. <a target="_blank" href="https://yandex.ru/profile/-/CCUsAKCWWC" style="color: red;">СК «Олимп»</a>
                <br>
                Московская область, Сергиево-Посадский городской округ, г. Хотьково, ул. Михеенко, д.25
            </h5>
        </div>

        <div class="col text-left mobFontSize d-sm-block d-md-none" style=" ">
            <h3 class="mob-title-sec" style="  ">Место проведения футбольных выходных</h3>

...
Забронируйте место сейчас и получите скидку
    ...
    font-family: IBMPlexSans, sans-serif !important;">{{ $main->price_discount }} ₽</span>  {{ $main->price }} ₽ </p>
            ...
            <div class="d-none d-md-block">
                ...
                <div class="col-md-4"><div class="rectangleHome3" style="height: 220px !important;   width: 376px !important;  ">
                        <img src="{{asset('assets/icons_price/ico1.svg')}}" alt="">
                        <h3 style="  font-size: 18px !important;">Официальный сертификат от компании </h3>
                    </div>
                </div>

                <div class="col-md-4">
                    <div class="rectangleHome3" style="height: 220px !important;  width: 376px !important; ">
                        <img src="{{asset('assets/icons_price/ico2.svg')}}" alt="">
                        <h3 style="  font-size: 18px !important;">Памятные футбольные сувениры</h3>
                    </div>
                </div>

                <div class="col-md-4"><div class="rectangleHome3" style="height: 220px !important;  width: 376px !important; "><img src="{{asset('assets/images/wekeends/bus.svg')}}" alt="">
                        ...
                        <div class="advantageCard2" style=" padding: 32px 24px;">
                            <div class="row">
                                <div class="col-md-2 text-left">
                                    <img src="{{asset('assets/icons_price/ico1.svg')}}" style="   display: block;
  margin: 0 auto;">
                                </div>
                                <div class="col-md-10 text-left">

                                    <h3 style="    text-align: center !important; font-size: 18px !important;">
                                        Официальный сертификат от компании
                                    </h3>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="reviewCard-area2">
                        <div class="advantageCard2" style=" padding: 32px 24px;">
                            <div class="row">
                                <div class="col-md-2 text-left">
                                    <img src="{{asset('assets/icons_price/ico2.svg')}}" style="   display: block;
  margin: 0 auto;">
                                </div>
                                <div class="col-md-10 text-left">

                                    <h3 style="    text-align: center !important; font-size: 18px !important;">
                                        Памятные футбольные сувениры
                                    </h3>
                                </div>
                            </div>
                        </div>

...
<div class="  d-none d-md-block" style="    background-color: #fafafa;  margin-top: 50px;   padding-top: 30px !important;">
    <div class="container">
        <div class="firstSection" style="">
                    ...
                    <div class="col-md-8">
                        <div class="row">
                                ...
                                <h3 style="font-family: Montserrat Alternates;margin-top: 25px;font-size: 50px;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.1;letter-spacing: normal;color: #303337;">
                                 Другие локации и форматы участия
                                </h3>
...
<div class="topPartsGray d-sm-block d-md-none" style="margin-top: 50px; padding-top: 30px !important;">
    <div class="container">
        <div class="firstSection">
            <div class="row">
                <div class="col-12 firstSectionDescription text-center">
                    <h3>Другие локации и форматы участия

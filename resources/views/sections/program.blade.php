        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h3 class="title-desc" style="margin-bottom: 32px !important;">Летний лагерь Школы мяча —
                        это не только про спорт!</h3>
                    <h5 class="text-desc " style="font-size: 26px; ">
                        Все наши смены, помимо спортивной направленности и отсутствия гаджетов являются тематическими и развивающими участников в комфортной и органичной для них атмосфере.
    ...
    margin-top: 40px;">
        <div class="container">
            <div class="col-md-12 text-center">
                <h3 class="title-desc-mob" style="margin-bottom: 0px !important;">Летний лагерь Школы мяча —
                    это не только про спорт!
                </h3>

                <h4 style=" font-size: 18px; margin-top: 12px !important; margin-bottom: 32px !important;">Все наши смены, помимо спортивной направленности и отсутствия гаджетов являются тематическими и развивающими участников в комфортной и органичной для них атмосфере.</h4>
            </div>
            ...
            @foreach($programs as $program)
                <div class="col-md-4">
                    <div class="catalog-card">
                        <div class="cardImg">
                            <img src="{{ asset('/storage/') }}/{{ str_replace("public/", "", $program->img) }}" alt="">
                        </div>

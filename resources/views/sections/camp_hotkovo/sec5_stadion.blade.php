...
<div class="seventhSection"  style="margin-top: 50px; margin-bottom: 48px;">
    <div class="container">
        <div class="mobSeventhSection col-md-12 text-center d-none d-md-block">
            <h3 class="title-desc" style=" margin-bottom: 35px !important;">Удобное местоположение лагеря</h3>
            <h5 class="text-desc " style="font-size: 20px; ">
                Лагерь будет проходить на территории спорткомплекса «Олимп», расположенного в 70 минутах езды от Москвы
                <br>
                г. Хотьково, ул. Михеенко д. 25
            </h5>
        </div>

        <div class="col text-left mobFontSize d-sm-block d-md-none" style=" ">
            <h3 class="mob-title-sec" style="  ">Удобное местоположение лагеря</h3>

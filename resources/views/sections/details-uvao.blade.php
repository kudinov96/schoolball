            ...
            <div class="col-auto center-block  text-center">
              <div class="toggler" style="width: auto !important;">
                <ul class="row nav nav-tabs nav-tabs-info nav-justified" style="border-bottom: none;">
                  <li class="col nav-item" style="padding: 0px 10px 1px 30px;">
                  ...
                  <li class="col nav-item" style="    padding: 0px 41px 0px 12px;">
...
width: 100%; height: auto !important;">
      ...
      <div class="fourthSection d-sm-block d-md-none">
        <div class="container">
          ...
          <div class="row mobile-advantage-slider">
            <div>
              <div id="tab-1" class="kidsSkills tab-pane active" style="padding-top: 10px;
    width: 100%;
    margin: 25px 14% 0 2%;
    ...
    padding-bottom: 35px;">
            ...
            <div>
              <div id="tab-2" class="kidsSkills tab-pane active" style="padding-top: 10px;
    width: 100%;
    margin: 25px 14% 0 2%;
    height: auto !important;
    padding-bottom: 35px;">
            ...
            <div>
              <div id="tab-3" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-4" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-5" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-6" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-7" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-8" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
            ...
            <div>
              <div id="tab-9" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">

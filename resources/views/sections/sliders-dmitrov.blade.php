    ...
    font-family: IBMPlexSans, sans-serif !important;">{{ $main->price_discount }} ₽</span>  {{ $main->price }} ₽ </p>
            ...
            <div class="d-none d-md-block">
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-md-3"><div class="rectangleHome5" style="height: 220px !important;      width: 253px !important; "><img src="{{asset('assets/icons_club/ico-4@1x.svg')}}" alt="">
                            <h3 style="  font-size: 18px !important;"> Пляжный отдых и солнце</h3></div>
                    </div>
                    ...
                    <div class="col-md-3"><div class="rectangleHome5" style="height: 220px !important;      width: 253px  !important;  ">
                            ...
                            <h3 style="  font-size: 18px !important;">Комплект формы в подарок</h3>
                        </div>
                    </div>
  ...
  margin: 0 auto; ">
                    ...
                    <div class="reviewCard-area2" >
                        <div class="advantageCard2"  style=" padding: 32px 24px;">
                            <div class="row">
                                <div class="col-md-2 text-left">
                                    <img src="{{asset('assets/icons_club/ico-4@1x.svg')}}" style="  display: block;
  margin: 0 auto; ">
                                </div>
                                <div class="col-md-10 text-left">

                                    <h3 style="    text-align: center !important; font-size: 18px !important;">
                                        Пляжный отдых и солнце
                                    </h3>
                                </div>
                            </div>
                        </div>

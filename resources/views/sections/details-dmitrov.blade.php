                    ...
                    <ul class="row nav nav-tabs nav-tabs-info nav-justified" style="border-bottom: none;">
                        ...
                        <li class="col nav-item" style="padding:0 8px 0 0;">
                            <a class="nav-link groupTogler" data-toggle="tab" href="#tab-4" style="width: 115px !important;">
                                <h4 style="width: 88px !important;">Пляж</h4>
                            </a>
                        </li>
                        <li class="col nav-item" style="padding:0 8px 0 0;">
                            <a class="nav-link groupTogler" data-toggle="tab" href="#tab-5" style="width: 129px !important;">
                                <h4 style="width: 111px !important;">Мини-гольф</h4>
                            </a>
                        </li>
                        <li class="col nav-item" style="padding:0 8px 0 0;">
                            <a class="nav-link groupTogler" data-toggle="tab" href="#tab-6" style="width: 115px !important;">
                                <h4 style="width: 88px !important;">Анимация</h4>
                            </a>
                        </li>
                        <li class="col nav-item" style="padding:0 8px 0 0;">
                            <a class="nav-link groupTogler" data-toggle="tab" href="#tab-7" style="width: 128px !important;">
                                <h4 style="width: 94px !important;">Проживание</h4>
                            </a>
                        </li>
                        <li class="col nav-item" style="padding:0 8px 0 0;">
                            <a class="nav-link groupTogler" data-toggle="tab" href="#tab-8" style="width: 151px !important;">
                                <h4 style="width: 96px !important;">Позаботимся</h4>
                            </a>
                        </li>
                ...
                <div id="tab-1" class="kidsSkills tab-pane active" style="    height: 490px;  padding-bottom: 35px;">
                    <div class="row">
                        ...
                        <div id="campVideoEdu" class="col-md-5" style="cursor:pointer">
                            <img src="{{ asset('assets/images/camp2/IMG_4569-min.jpg') }}" style="  border-radius: 10px;
width: 100%; height: auto !important;">
                ...
                <div id="tab-2" class="kidsSkills tab-pane" style="    height: 490px;  padding-bottom: 35px;">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/img-1@2x.png') }}" style="width: 100%; height: auto !important;">
                        </div>
                        <div class="col-md-1">
                ...
                <div id="tab-4" class="kidsSkills tab-pane" style="    height: 490px;  padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3>Пляж</h3>
                            <p>
                                ✓   Ухоженный песочный пляж с озером<br>
                                ✓   За детьми следят несколько тренеров <br>
                                ✓   Важный элемент восстановления
                            </p>
                        </div>
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/img-2@2x.png') }}" style="width: 100%; height: auto !important;">
                        </div>
                        <div class="col-md-1">
                ...
                <div id="tab-5" class="kidsSkills tab-pane" style="    height: 490px; padding-bottom: 35px;">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/img-3@2x.png') }}" style="width: 100%; height: auto !important;">
                        </div>
                        <div class="col-md-1">
                ...
                <div id="tab-6" class="kidsSkills tab-pane" style="    height: 490px;padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3>Интересный квест</h3>
                            <p>
                                ✓	Развитие командного духа <br>
                                ✓	Новые захватывающие эмоции <br>
                                ✓	Познавательные задания

                            </p>
                        </div>
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/img-4@2x.png') }}" style="width: 100%; height: auto !important;">
                        </div>
                ...
                <div id="tab-7" class="kidsSkills tab-pane" style="    height: 490px; padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3>Проживание</h3>
                            <p>
                                ✓	Проживание в деревянных коттеджах<br>
                                ✓	По 4 человека в номере <br>
                                ✓	Все удобства в номере <br>
                                ✓	Wi-Fi
                            </p>
                        </div>
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/img-5@2x.png') }}" style="width: 100%; height: auto !important;">
                        </div>
                ...
                <div id="tab-8" class="kidsSkills tab-pane" style="    height: 490px; padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3>Позаботимся</h3>
                            <p>
                                ✓	Питьевая вода в неограниченном объеме<br>
                                ✓	Свежие фрукты ежедневно <br>
                                ✓	Персональный подход к каждому ребенку <br>
            ...
            <div>
                <div id="tab-1" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 14% 0 2%;height: auto !important;padding-bottom: 35px;">
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <img src="{{ asset('assets/images/camp2/IMG_4569-min.jpg') }}" style=" margin-top:10px; border-radius: 10px;
width: 100%; height: auto !important;">
                        </div>
                        <div class="col-md-1">
            ...
            <div>
                <div id="tab-4" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 14% 0 2%;height: auto !important;padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3 style="font-size:22px">Пляж </h3>
                            <p style="font-size: 12px;">
            ...
            <div>
                <div id="tab-5" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 14% 0 2%;height: auto !important;padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3 style="font-size:22px"> Мини-гольф</h3>
                            <p style="font-size: 12px;">
                                ✓	Активный отдых на свежем воздухе <br>
                                ✓	Интересные задания <br>
                                ✓	Развитие ловкости и концентрации
            ...
            <div>
                <div id="tab-6" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 100%;margin: 25px 14% 0 2%;height: auto !important;padding-bottom: 35px;">
                    <div class="row">
                        <div class="col-md-6 kidsSkillsText">
                            <h3 style="font-size:22px">Интересный квест</h3>
                            <p style="font-size: 12px;">
                                ✓	Развитие командного духа <br>
                                ✓	Новые захватывающие эмоции <br>
                                ✓	Познавательные задания

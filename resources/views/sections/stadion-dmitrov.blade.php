...
<div class="seventhSection"  style="margin-top: 50px; margin-bottom: 48px;">
    <div class="container">
        <div class="mobSeventhSection col-md-12 text-center d-none d-md-block">
            <h3 class="title-desc" style=" margin-bottom: 35px !important;">Удобное месторасположение лагеря</h3>
            <h5 class="text-desc " style="font-size: 20px; ">
                Кэмп будет проходить на территории Отеля «Дмитров Гольф Резорт» 4*, расположенного в 80 минутах езды от Москвы
                <br>
                Московская обл., Дмитровский район, дер. Курово, д.69
        ...
        <div class="col text-left mobFontSize d-sm-block d-md-none" style=" ">
            <h3 class="mob-title-sec" style="  ">Удобное месторасположение лагеря</h3>
            <h5 class="text-desc " style="font-size: 18px;    text-align: left !important; ">
                Кэмп будет проходить на территории Отеля «Дмитров Гольф Резорт» 4*, расположенного в 80 минутах езды от Москвы
                <br>
                Московская область, Одинцовский г.о., д. Ястребки, парк-отель «Горизонт»

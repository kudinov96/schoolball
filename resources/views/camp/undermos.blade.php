...
@section('content')
          ...
          <div class="firstSection">
            <div class="row">
              <div class="col-md-6 firstSectionDescription">
                <h3>Летний лагерь в Подмосковье (Хотьково)</h3>
                <p style="text-decoration: underline; color:#656565;font-family: 'IBMPlexSans-Bold';font-size:22px;">Для детей от 8 до 14 лет</h4>
                <h4 style="font-size: 26px !important;">Михеенко д. 25, Хотьково, Сергиево-Посадский городской округ, спорткомплекс «Олимп»</h4>
                <h3 class="underlineHover" style="cursor: pointer;font-family: IBMPlexSans-Bold;font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUB6VHaPD', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
              ...
              <div class="col-md-6">
                <img src="{{ asset('assets/images/camp/main-logo-umos.png') }}" alt="" style="width: 90%;">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="firstSection">
            <div class="row">
              ...
              <div class="col-12 firstSectionDescription text-center">
                <h3>Летний лагерь в Подмосковье (Хотьково)</h3>
                <p style="text-decoration: underline; color:#656565;font-family: 'IBMPlexSans-Bold';font-size:22px;">Для детей от 8 до 14 лет</h4>
                <h4>Михеенко д. 25, Хотьково, Сергиево-Посадский городской округ, спорткомплекс «Олимп»</h4>
                <button type="button" name="button" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Получить консультацию</button>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center mobSeventhSection">
              <h3 style="margin-bottom: 65px;margin-top: 30px;font-family: IBMPlexSans-Bold;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;text-align: center;color: #303337;">Выездной лагерь в Подмосковье на спортивной базе «Олимп» <br>(видео, как это было в прошлый раз)</h3>
            </div>
            <div id="campVideoEdu" class="col-md-6 offset-md-3 thirdSectionImg">
              <img src="https://schoolball.ru/assets/images/camp/someCampVideo-umos.png" alt="" style="width: 100%;">
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                ...
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Свежий воздух в Подмосковье</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
            ...
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                <img src="{{ asset('assets/images/camp/ico_sofa.svg') }}" style="margin-top: 15px;">
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Полный пансион</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center">
              <h3 style="margin: 65px 0;">Мы продумали каждую деталь и предлагаем насыщенную активностями программу:</h3>
            </div>
              ...
              <div id="tab-2" class="kidsSkills tab-pane" style="height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3>Накормим</h3>
                    <p>
                      Чтобы добиться высоких спортивных результатов, важно правильно дозировать нагрузки и обеспечивать восстановление после них. На время проведения лагеря наши специалисты подготовили меню полноценного спортивного питания в формате «шведского стола». Участники питаются в ресторане 4 раза в день.
                    </p>
                  </div>
                  <div class="col-md-5">
              ...
              <div id="tab-5" class="kidsSkills tab-pane" style="height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3>Посмотрим</h3>
                    <p>
                      ✓ Удобная лаунж-зона с проектором для просмотра фильмов
                      ✓ Подборка мотивационных фильмов
                      ✓ Все фильмы соответствуют возрастной категории
                    </p>
                  </div>
                  <div class="col-md-5">
              ...
              <div id="tab-7" class="kidsSkills tab-pane" style="height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3>Покричим</h3>
                    <p>
                      ✓	4 приставки PlayStation <br>
                      ✓	8 джойстиков <br>
                      ✓	Комфортабельные диваны <br>
        ...
        <div class="container">
          <div class="row">
            <div class="col-md-12 campLocation text-center">
              ...
              <h3 style="">Мы продумали каждую деталь и предлагаем насыщенную активностями программу:</h3>
            </div>
          </div>
        ...
        <div class="container">
          <div class="row">
              ...
              <div class="camp-table text-center">
                <table>
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>2</td>
                      <td>5 августа - 14 августа</td>
                      <td>32</td>
                      <td class="d-none d-md-block">25</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="col-12 text-center">
              ...
              <p> Полный пансион с ночевкой в номерах </p>
            </div>
            <div class="w-100"></div>
            <div class="col-md-4">
            ...
            <div class="col-md-8">
              <div class="camp-table text-center">
                <table>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">07:30</td>
                    <td>Подъем</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">07:30 - 07:45</td>
                    <td>Утренняя зарядка</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">08:00 - 08:30</td>
                    <td>Завтрак</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">09:30 - 10:30</td>
                    <td>Тренировка по футболу (развитие техники)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">10:30 - 11:00</td>
                    <td>Развитие гибкости и ловкости</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">11:00 - 12:00</td>
                    <td>Бассейн и хамам</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                  ...
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">13:30 - 15:30</td>
                    <td>Тихий час</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">15:30 - 16:00</td>
                    <td>Спортивный полдник</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">16:30 - 18:00</td>
                    <td>Тренировка по футболу (игровая)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                  ...
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">20:30 - 21:30</td>
                    <td>Лаунж зона</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">21:30 - 22:00</td>
                    <td>Командное собрание - итоги дня</td>
                  </tr>
                  <tr>
                    <td width="150">22:00</td>
                    <td>Отбой</td>
                  </tr>
                </table>
              </div>
        ...
        <div class="container">
          <div class="row">
            <div class="mobSeventhSection col-md-12 text-center">
              <h3 style="margin: 65px 0;">Тренерский состав</h3>
              <h4>Занятия проводят профессиональные детские тренеры с богатым опытом работы</h4>
            </div>
          </div>
      ...
      <div class="secondSection" id="lightbox">
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center mobSeventhSection">
              <h3 style="margin-bottom: 65px;margin-top: 30px;font-family: IBMPlexSans-Bold;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;text-align: center;color: #303337;">Посмотрите видео о нашем лагере</h3>
            </div>
            ...
            <div class="w-100"></div>
            <div class="col text-center mobFontSize">
              <h3 style="margin: 65px 0;">Вам подходит наш лагерь, если хотите:</h3>
            </div>
            <div class="w-100"></div>
              ...
              <div class="row mobile-advantage-slider">
                <div class="col-12">
                  <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                    ...
                    <b><h4 style="height: 48px;font-family: IBMPlexSans;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Яркие каникулы с пользой</h4></b>
                  </div>
                </div>
                <div class="col-12">
                  <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                    <img src="{{ asset('assets/images/camp/9.svg') }}" style="margin-top: 15px;">
                    <b><h4 style="height: 48px;font-family: IBMPlexSans;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Занятия с профессионалами своего дела</h4></b>
                  </div>
                </div>
                <div class="col-12">
                  <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
      ...
      <div class="sixthSection d-none d-md-block" style="margin-bottom: 65px;">
        <div class="container">
          <div class="row">
            <div class="col text-center">
              <h3 style="margin: 65px 0;">Стоимость участия в выездном лагере</h3>
            </div>
            <div class="w-100"></div>
            <div class="col-md-4 offset-4">
              <div class="trainingVariants" id="IMG_9905" style="height: 200px !important;">
                  ...
                  <h3 style="font-size: 18px;line-height: 20px;margin-bottom: auto !important;">Полная смена<br><span style="font-size: 12px;font-family: 'IBMPlexSans';">10 дней (выезд с ночевкой)</span></h3>
                  <div class="row">
            ...
            <div class="col-12">
              <h3><b><a href="tel:+79013836006">+7 (901) 383-60-06</a></b></h3>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="container">
          <div class="row" style="margin-bottom:30px">
            <div class="col text-center">
              ...
              <h3 style="font-size: 28px;margin-bottom: 5px;">Стоимость участия в выездном лагере</h3>
            </div>
            <div class="w-100"></div>
          </div>
              ...
              <div class="mobTrainingVariants" id="" style="height: 200px !important;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-6 trainingInfo_camp " style="height: auto !important;">
                      <h4 style="font-size: 14px;">49690 ₽</h4>
                    </div>
                    <div class="col-6">
                      <button type="button" name="button" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Записаться</button>
                    </div>
          ...
          <div class="row">
            <div class="col-12">
              <h4><b><a href="tel:+79013836006">+7 (901) 383-60-06</a></b></h4>
            </div>
          </div>
        </div>
      </div>

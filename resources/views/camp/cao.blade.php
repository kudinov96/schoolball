...
@section('title')
    <title>Детский футбольный лагерь дневного пребывания на Киевской в Москве</title>
@endsection
@section('description')
    <meta property="og:description" content="Обращайтесь в детский футбольный лагерь дневного пребывания от Школы Мяча - научим играть в футбол вашего ребенка">

    <meta name="description" content="Обращайтесь в детский футбольный лагерь дневного пребывания от Школы Мяча - научим играть в футбол вашего ребенка">
@endsection
...
@section('content')
            ...
            <div class="row">
              ...
              <div class="col-12 firstSectionDescription text-center">
                ...
                <h4>Ребенок с 9 до 19 часов погружается в дружескую атмосферу, учится достигать цели и находится в балансе между отдыхом и физическими нагрузками
                  ...
                  <h3 class="underlineHover" style="font-size: 18px; color: #f44336;     margin-top: 15px;"> м. Киевская </h3>
                  <h3 class="underlineHover" style="cursor: pointer;font-size: 25px; margin-top: 11px; font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUQeNESgA', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
   ...
   ?>
      ...
      @include('sections.stadion-burevestnik')
      ...
      @include('sections.grafikSmen-cao')

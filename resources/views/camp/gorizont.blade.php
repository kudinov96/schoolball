...
@section('title')
    <title>Футбольный лагерь в Подмосковье для детей на лето 2023</title>
@endsection
@section('description')
    <meta property="og:description" content="Обращайтесь в детский футбольный лагерь в Подмосковье от Школы Мяча - научим играть в футбол вашего ребенка">
    <meta name="description" content="Обращайтесь в детский футбольный лагерь в Подмосковье от Школы Мяча - научим играть в футбол вашего ребенка">
@endsection
...
@section('content')
    ...
    text-align: left;  margin-top: 11px !important;
                " onclick="window.open('https://yandex.ru/maps/-/CBeMR8Hd8B', '_blank')">Парк-отель «Горизонт» 4*
                  </h3>

                  <h3 class="underlineHover" style="cursor: pointer;font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CBeMR8Hd8B', '_blank')">Построить маршрут<span style="font-size: 25px;">→</span></h3>

               </div>
              <div class="col-md-6">
                <img src="{{ asset('assets/images/camp/main-logo-gorizont.png') }}" alt="" style="width: 90%;">
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="firstSection">
            <div class="row">
              ...
              <div class="col-12 firstSectionDescription text-center">
                <h1 class="h1-title-mob">Летний футбольный лагерь в Подмосковье</h1>
                <h4>Ребенок на целую неделю погружается в дружескую атмосферу, учится достигать цели и находится в балансе между отдыхом и физическими нагрузками
                  ...
                  <h3 class="underlineHover" style="font-size: 18px; color: #f44336;     margin-top: 15px;">Парк-отель «Горизонт» 4* </h3>
                  <h3 class="underlineHover" style="cursor: pointer;font-size: 25px; margin-top: 11px; font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CBeMR8Hd8B', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
      ...
      @include('sections.summer-gorizont')
   ...
   ?>
      ...
      @include('sections.details-gorizont')
      ...
      @include('sections.schedule-gorizont')
      ...
      @include('sections.stadion-gorizont')

      <!-- Посмотрите видео с прошлых смен !-->

      @include('sections.video-gorizont')
      ...
      @include('sections.sliders-gorizont')

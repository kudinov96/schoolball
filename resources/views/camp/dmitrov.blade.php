...
@section('title')
    <title>Детский футбольный лагерь в Дмитрове</title>
@endsection
@section('description')
...
@section('content')
          ...
          <div class="firstSection">
            <div class="row">
              <div class="col-md-6 firstSectionDescription">
                <h3>Летний футбольный лагерь в Подмосковье </h3>
    ...
    text-align: left;  margin-top: 11px !important;
              ...
              <div class="col-md-6">
                <img src="{{ asset('assets/images/camp/main-logo-dmitrov.png') }}" alt="" style="width: 90%;">
              </div>
            </div>
          </div>
        </div>
      ...
      @include('sections.summer-dmitrov')
   ...
   ?>
      ...
      @include('sections.details-dmitrov')
      ...
      @include('sections.schedule-dmitrov')
      ...
      @include('sections.stadion-dmitrov')

      <!-- Посмотрите видео с прошлых смен !-->

      @include('sections.video-dmitrov')
      ...
      @include('sections.sliders-dmitrov')

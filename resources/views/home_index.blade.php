            ...
            <div class="firstSection">
                <div class="row">
                    <div class="col-md-7 firstSectionDescription">
                        ...
                        <h3>УЧИМ ИГРАТЬ
                            В ФУТБОЛ И ПОМОГАЕМ ВЗРОСЛЕТЬ </h3>

                        <h4>Приглашаем юных спортсменов от 3 до 16 лет на пробное занятие в клубы Школы мяча.</h4>
        ...
        <div    class="secondSection d-none d-md-block">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-5">
                        <div class="list-group prokrutka">
                            <?php /*
                            <button data-objectId="1" class="list-group-item">
                                <h4 class="map-header  list-group-item-heading"><img src="{{asset('assets/group-6-copy@3x.png')}}" style=" width: 12px;
  height: 12px;"> Главный офис</h4>
                                <p class="map-addres list-group-item-text">Москва, ул. Название, 00</p>
                            </button>

                            <button    data-objectId="12" class="list-group-item">
                                <h4 class="map-header list-group-item-heading">Все клубы</h4>
                                <p class="map-addres list-group-item-text">Москва и МО</p>
                            </button>
 */ ?>
                            ...
                            @foreach ($clublist as $club)
                                <button data-objectId="{{$club->id}}" class="list-group-item">
                                    <h4 class="map-header  list-group-item-heading">{{$club->name}}</h4>
                                    <p class="map-addres list-group-item-text">{{ $club->address }} </p>
                                    <p class="map-addres list-group-item-text"> <a href="/club_{{ $club->slug }}" target="_blank">Узнать расписание</a></p>
                                </button>
                        ...
                        <script>
                            document.addEventListener('DOMContentLoaded', function() {
                                ...
                                function init () {
                                    ...
                                    // что просиходит при выборе метки или варианта из списка
 ...
 */?>
  ...
  background-color: #fff;
    ...
    margin-left: -16px;">
                    <div id="clubsmob"  style="visibility: hidden;position: relative;top: -100px;"></div>

                    <h3 class="mob-title-sec" style="     margin-top: 84px;">Футбольные клубы рядом с домом</h3>
                </div>

            </div>

            <div class="list-group prokrutka-mob" style="margin-bottom: 32px;">
                <?php /*
                <button data-objectId="1" class="list-group-item " style="    border-bottom: 1px solid #e4e9ec!important;
    padding-bottom: 4px;
    padding-top: 0px;">
                    <div class="border-left">
                        <div class="border-l">
                            <h4 class="map-header  list-group-item-heading"><img src="{{asset('assets/group-6-copy@3x.png')}}" style=" width: 12px;
  height: 12px; color: #6e6d7a !important;"> Главный офис</h4>
                            <p class="map-addres list-group-item-text">Москва, ул. Название, 00</p>
                        </div>
 ...
 */ ?>
  ...
  height: 608px;
    ...
    <div class="thirdSection" id="lightbox">
        <div class="container">
            <!-- Section -Укрепляем тело, развиваем личность! mob-->

            <div class="col text-left mobFontSize-section2 d-sm-block d-md-none" style="
    margin-left: -16px;">
                <h3 class="mob-title-sec" style="     margin-top: 84px;">Укрепляем тело, развиваем личность</h3>
            </div>

            <h5 style="  font-family: IBMPlexSans;
  font-size: 16px;
  font-weight: normal;
  font-stretch: normal;
  font-style: normal;
  ...
  color: #303337;" class="d-sm-block d-md-none">
                Для нас и наших учеников футбол — больше чем игра. Это стиль жизни, <b>развитие личностных качеств</b> и
                <b>коммуникативных навыков.</b> <br><br>

                На тренировках юные футболисты знакомятся с игровым мышлением, развивают <b>воображение</b> и <b>лидерские
                    качества</b>, учатся <b>договариваться</b> с другими участниками команды и быстро <b>принимать решения</b>.<br><br>
                Наши тренеры уделяют особое внимание <b>психоэмоциональному развитию</b> спортсменов: учат их не только
                побеждать, но и с честью <b>признать поражение</b>, расти на своих ошибках и <b>верить в свои силы</b>.<br><br>
            </h5>
            <!-- Section -Укрепляем тело, развиваем личность! mob-->
            ...
            <div class="row">
                ...
                <div class=" d-sm-block d-md-none col-12 thirdSectionImg">
                    <img src="{{ asset('assets/Group 40.png') }}" alt="" @click="lightbox = !lightbox"
                         style="width: 100%;">
                </div>
            ...
            <div class="iframe">
                <div class="row justify-content-center">
                    <div class="col text-center">
                        <iframe opacity="1" width="100%" height="555" src="https://www.youtube.com/embed/I5gAalyf4Ts"
                                frameborder="0"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 text-center">
                        ...
                        <h3 class="title-desc">Методика подготовки футболистов</h3>
                        <h4 class="main_desc">
    ...
    margin-left: -16px;">
                    ...
                    <h3 class="mob-title-sec" style="     margin-top: 84px;">Методика подготовки футболистов</h3>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class=" col-auto center-block  text-center">
                    ...
                    <h3 class="title-desc">Пробная тренировка бесплатно</h3>
                    <h4 class="main_desc">
                        Оставьте заявку на пробную тренировку, и наш менеджер подберёт подходящую по возрасту
                        и расписанию группу в клубе в вашем районе. Присутствуя на занятии, вы увидите, как проходит
                        тренировка, и сможете задать вопросы тренеру после её окончания. В случае присоединения
                        к клубу первая тренировка включается в абонемент. </h4>
    ...
    <div class="secondSection d-none d-md-block">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h3 class="title-desc" style="margin-top: -55px !important;">Кубок Школы мяча</h3>
                </div>
 ...
 */ ?>
                                ...
                                <div class="">
                                    ...
                                    <div id="callback-2-front">
                                        ...
                                        <div class="input-group mb-3">
                                                 @csrf
                                            <input type="text"  name="phone"  style="    border: 0px solid #d6d6df !important;" class="phone form-control" placeholder="+7 495 800-22-40" aria-describedby="basic-addon2">
                ...
                <div class="row d-flex justify-content-center">
                    ...
                    <div class="col-md-7">
                        ...
                        <div class="card p-3 py-4">
                            ...
                            <div class="text-center">
                                <img src="{{ asset('assets/bitmap@2x.png') }}" width="100" class="rounded-circle">
                            </div>

                            <div class="text-center mt-3">
                                <h5 class="mt-2 mb-0 director-name">Вершинин Андрей Андреевич</h5>
                                <span class="director-subname">Руководитель компании</span>

                                <div class="text-center ">
                                    <!-- <img src="{{ asset('assets/vk 2.png') }}" alt=""> -->
                                    <a href="https://vk.com/school_ball_industry"><img class="director-social"
                                                                                       src="{{ asset('assets/footer_icons/vk-2.svg') }}"
                                                                                       alt=""></a>

                                    <!-- <img src="{{ asset('assets/facebook 2.png') }}" alt=""> -->
                                    <a href="https://www.facebook.com/schoolballindustry"><img class="director-social"
                                                                                               src="{{ asset('assets/footer_icons/facebook-2.svg') }}"
                                                                                               alt=""></a>

                                    <!-- <img src="{{ asset('assets/instagram 2.png') }}" alt=""> -->
                                    <a href="https://www.instagram.com/schoolball_industry/"> <img
                                            class="director-social"
                                            src="{{ asset('assets/footer_icons/instagram-2.svg') }}" alt=""></a>

                                    <!-- <img src="{{ asset('assets/youtube.png') }}" alt=""> -->
                                    <a href="https://www.youtube.com/channel/UCxIC4Zb67ogcc-SKiyu8Zhg?view_as=subscriber">
                                        <img class="director-social"
                                             src="{{ asset('assets/footer_icons/twitter-2.svg') }}" alt=""></a>
                    ...
                    <div class="px-4 mt-1">
                        <p class="director-quote">
                            «На моих глазах вырастает новое поколение футболистов. Они не только знают, как вести себя
                            на поле и мастерски управляют мячом, но и умеют договариваться, выстраивать общую стратегию,
                            быстро оценивать риски и принимать решения. И это футбол будущего, основы которого мы
                            закладываем в клубах Школы мяча.»
                        </p>
    ...
    <div class="fourthSection d-sm-block d-md-none" style="margin-top: 87px !important; ">
        <div class="container">
            ...
            <div class="col text-left mobFontSize" style="
    margin-left: -16px;">
                <h3 class="mob-title-sec" style="     margin-top: 42px;">Присоединяйтесь
                    к сообществу Школы мяча</h3>
            </div>
...
">Наши партнёры</h3>
    ...
    margin-left: -16px;">
            ...
            <div class="col-12 d-sm-block d-md-none" style="">
                ...
                <div class="row">
                    <div class="col-4"><img class="mob-partner-image"  src="{{ asset('assets/partners/logo-p-1-2-x@2x.png') }}"></div>
                    <div class="col-4"><img class="mob-partner-image"  src="{{ asset('assets/partners/logo-p-2-2-x@2x.png') }}"></div>
                    <div class="col-4"><img class="mob-partner-image"  src="{{ asset('assets/partners/logo-p-3-2-x@2x.png') }}"></div>

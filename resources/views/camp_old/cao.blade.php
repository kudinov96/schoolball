...
@section('content')
          ...
          <div class="firstSection">
            <div class="row">
              <div class="col-md-6 firstSectionDescription">
                <h3>Летний дневной лагерь в центральном округе</h3>
                <h4 style="font-size: 26px !important;">Стадион «Буревестник», ул. Плющиха, 57</h4>
    ...
    color: #f44336;
    text-align: left;
                " onclick="window.open('https://yandex.ru/maps/-/CCUQeNESgA', '_blank')">м. Киевская </h3>

                  <h3 class="underlineHover" style="cursor: pointer;font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUQeNESgA', '_blank')">Построить маршрут<span style="font-size: 25px;">→</span></h3>
          ...
          <div class="firstSection">
            <div class="row">
              ...
              <div class="col-12 firstSectionDescription text-center">
                <h3>Летний дневной лагерь в центральном округе </h3>
                <h4>Стадион «Буревестник», ул. Плющиха, 57</h4>
                  <h3 class="underlineHover" style="font-size: 18px; color: #f44336;"> м. Киевская </h3>
                  <h3 class="underlineHover" style="cursor: pointer;font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUQeNESgA', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
      ...
      <div class="secondSection">
          <div class="container">
              ...
              <div class="col-12  text-center">
                  ...
                  <h5 style="color: #303337;font-size: 28px;font-family: Montserrat Alternates;margin-bottom: 30px;">  Подарите своему ребенку счастливое лето и новых друзей.
                  </h5>
              </div>
      ...
      <div class="topPartsGra " style=" /* height: 420px; */;  background-position: center;">
          <div class="container">
              <div class="firstSection">
                  <div class="row">

                      <div class="col-md-12 firstSectionDescription" style="/* max-width: 65%; */-ms-flex: 0 0 65%;/* flex: 0 0 65%; */margin-top: 10px;" data-gtm-vis-first-on-screen-6041116_70="1701" data-gtm-vis-total-visible-time-6041116_70="100" data-gtm-vis-has-fired-6041116_70="1">
                                      ...
                                      <ul class="accordeon">
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Мальчики и девочки</div>
                                                </span>
                                          </div>
                                          ...
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Возраст участников: 5-15 лет</div>
                                                </span>
                                          </div>
                                          ...
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Любой уровень подготовки</div>
                                                </span>
                                          </div>
                                          ...
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Ближайшая смена: дд.мм (Пн.)</div>
                                                </span>
                                          </div>
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Смены по 10 будних дней (Пн. – Пт.)</div>
                                                </span>
                                          </div>
                                          ...
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">День длится с 09:00 до 19:00</div>
                                                </span>
                                          </div>
                                          ...
                                          <div class="accordeon__item">
                                                <span class="accordeon__activator">
                                                    ...
                                                    <div class="accordeon__label">Возможен индивидуальный график по датам и времени</div>
                                                </span>
                                          </div>
                                      ...
                                      <div class="col-12  text-center" style="margin-bottom: 30px;">
                                          ...
                                          <div class="row">
                                              <div class="col-lg-12">
                                                  ...
                                                  <h4 class="list_menu">Мальчики и девочки</h4>

                                              </div><!-- /.col-lg-4 -->

                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">Возраст участников: 5-15 лет</h4>

                                              </div><!-- /.col-lg-4 -->

                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">Любой уровень подготовки</h4>

                                              </div><!-- /.col-lg-4 -->
                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">Ближайшая смена: дд.мм (Пн.)</h4>

                                              </div><!-- /.col-lg-4 -->

                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">Смены по 10 будних дней (Пн. – Пт.)</h4>

                                              </div><!-- /.col-lg-4 -->

                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">День длится с 09:00 до 19:00</h4>

                                              </div><!-- /.col-lg-4 -->

                                              <div class="col-lg-4">

                                                  <h4 class="list_menu">Возможен индивидуальный график по датам и времени</h4>
      ...
      <div class="campVideoSection">
        <div class="container">
          <div class="row">
            <div class="col-md-12 text-center mobSeventhSection">
              <h3 style="margin-bottom: 65px;margin-top: 30px;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;text-align: center;color: #303337;">Стадион "Буревестник"</h3>
            </div>
            <div id="campVideoEdu" class="col-md-6 offset-md-3 thirdSectionImg">
              <img src="https://schoolball.ru/assets/images/camp/someCampVideo.png" alt="" style="width: 100%;">
            </div>
              ...
              <div class="iframe">
                <div class="row justify-content-center">
                  <div class="col text-center">
                    <iframe opacity="1" width="100%" height="555" src="https://www.youtube.com/embed/W5h5Wju5pSk" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                <img src="{{ asset('assets/images/camp/5.svg') }}" style="margin-top: 15px;">
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">В центре Москвы</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                <img src="{{ asset('assets/images/camp/6.svg') }}" style="margin-top: 15px;">
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Великолепная инфраструктура</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                <img src="{{ asset('assets/images/camp/7.svg') }}" style="margin-top: 15px;">
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Бассейн 25 м</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                <img src="{{ asset('assets/images/camp/4.svg') }}" style="margin-top: 15px;">
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Лучший тренерский состав</h4></b>
              </div>
            </div>
          </div>
        </div>
      </div>
      <div class="secondSection d-sm-block d-md-none" style="margin-top: 65px;">
        <div class="container">
          <div class="row ">
            <div class="col-6">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
      ...
      <div class="secondSection">
          <div class="container">
              ...
              <div class="col-12  text-center">
                  ...
                  <h5 style="color: #303337;font-size: 28px;font-family: Montserrat Alternates;margin-bottom: 30px;">  Идеально подойдёт для тех, кто не хочет расставаться с ребёнком на длительный срок или хочет «протестировать» готовность юного спортсмена к лагерю полного цикла, с ночёвкой.

                  </h5>

                  <div class="friends_button" style="text-align: center;">
                      <button type="button" class="btn btn-primary" name="button" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Свяжитесь со мной</button>
                  </div>
              </div>
      ...
      <div class="secondSection" id="lightbox">
          <div class="container">
              <div class="row">
                  <div class="col-md-12 text-center mobSeventhSection">
                      <h3 style="margin-bottom: 65px;margin-top: 30px;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;text-align: center;color: #303337;">Посмотрите видео о нашем лагере</h3>
                  </div>
                  <div class="col-md-6 offset-md-3 thirdSectionImg">
                      <img src="{{ asset('assets/images/camp/info.png') }}" @click="lightbox = !lightbox" style="width: 100%;">
                  </div>
                  <div v-if="lightbox">
                      <div class="lightboxBack" >
                      ...
                      <div class="iframe">
                          <div class="row justify-content-center">
                              <div class="col text-center">
                                  <iframe opacity="1" width="1060" height="555" src="https://www.youtube.com/embed/I5gAalyf4Ts" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                              </div>
                          </div>
                      </div>
                  </div>
      ...
      <div class="garantia " style="margin-top:15px ;background: url(https://schoolball.ru/assets/images/camp/backgraund-garant.png); height: 861px; background-repeat: no-repeat; background-position: center; margin-bottom: -200px;">
          <div class="container">
              <div class="row">
                  <div class="col text-center mobFontSize d-none d-md-block">
                      <h3 class="desc_heading" style="height: auto !important; margin: 65px 0;">Гарантия безопасности:</h3>
                  </div>

                  <div class="col text-center mobFontSize  d-sm-block d-md-none">
                      <h3 class="mob_heading" style="height: auto !important; margin: 65px 0;">Гарантия безопасности: </h3>
                  </div>
                  ...
                  <div class="col-md-4 d-none d-md-block">
                      <div class="advantage text-center" style="width: 100% !important; padding-left: 0!important; box-shadow: none!important;">
                          ...
                          <b><h4 style="height: 24px;font-size: 16px;color: #303337;">Во всех филиалах футбольного лагеря «Школы мяча» есть медицинский персонал, который будет следить за состоянием здоровья детей во время их пребывания в лагере</h4></b>
                      </div>
                  </div>
                  <div class="col-md-4 d-none d-md-block">
                      <div class="advantage text-center" style="width: 100% !important; padding-left: 0!important; box-shadow: none!important;">
                  ...
                  <div class="col-12 d-sm-block d-md-none">
                      <div class="row mobile-advantage-slider">
                          <div class="col-12">
                              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                                  <img src="<?php echo e(asset('assets/images/camp/ico_1.svg')); ?>" style="margin-top: 15px;">
                                  <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Здоровье</h4></b>
                                  <b><h4 style="height: 24px;font-size: 16px;color: #303337;">Во всех филиалах футбольного лагеря «Школы мяча» есть медицинский персонал, который будет следить за состоянием здоровья детей во время их пребывания в лагере</h4></b>
                          ...
                          <div class="col-12">
                              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                                  <img src="<?php echo e(asset('assets/images/camp/ico_2.svg')); ?>" style="margin-top: 15px;">
                                  <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Охрана</h4></b>
                                  <b><h4 style="height: 24px;font-size: 16px;color: #303337;">Соблюдение порядка на территории футбольного лагеря обеспечивает частная охранная организация. А потому вы можете быть спокойны за активный отдых своего ребенка.</h4></b>
                          ...
                          <div class="col-12">
                              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                                  <img src="<?php echo e(asset('assets/images/camp/ico_3.svg')); ?>" style="margin-top: 15px;">
                                  <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Ежедневная уборка</h4></b>
                                  <b><h4 style="height: 24px;font-size: 16px;color: #303337;">Наш клининговый персонал ежедневно выполняет уборку территории лагеря и дезинфекцию помещений, чтобы вы были спокойны за здоровье ребенка во время его пребывания в лагере.</h4></b>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 text-center">
              ...
              <h3 style="margin: 65px 0;">График смен</h3>
            </div>
            <div class="w-100"></div>
            <div class="col-md-4">
                  ...
                  <tbody>
                    <tr style="border-bottom: 1px solid lightgray;">
                      ...
                      <tr style="border-bottom: 1px solid lightgray;">
                        ...
                        <td>32</td>
                        <td class="d-none d-md-block">12</td>
                      </tr>
                      <tr style="border-bottom: 1px solid lightgray;">
                        <td>3</td>
                        <td>27 июня - 8 июля</td>
                        <td>32</td>
                        <td class="d-none d-md-block">19</td>
                      </tr>
                      <tr style="border-bottom: 1px solid lightgray;">
                        <td>4</td>
                        <td>11 июля - 22 июля</td>
                        <td>32</td>
                        <td class="d-none d-md-block">23</td>
                      </tr>
                      <tr style="border-bottom: 1px solid lightgray;">
                        <td>5</td>
                        <td>25 июля - 5 августа</td>
                        <td>32</td>
                        <td class="d-none d-md-block">24</td>
                      </tr>
                      <tr style="border-bottom: 1px solid lightgray;">
                        <td>6</td>
                        <td>8 августа - 19 августа</td>
                        <td>32</td>
                        <td class="d-none d-md-block">17</td>
                      </tr>
                      <tr>
                        <td>7</td>
                        <td>22 августа - 26 августа</td>
                        <td>32</td>
                        <td class="d-none d-md-block">14</td>
                      </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="col-12 text-center">
              ...
              <h3 style="margin: 65px 0;">Распорядок дня</h3>
              <p> Полупансион по будням </p>
            </div>
            <div class="w-100"></div>
            <div class="col-md-4">
            ...
            <div class="col-md-8">
              <div class="camp-table text-center">
                <table>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">09:00</td>
                    <td>Встреча участников</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">09:30</td>
                    <td>Первая тренировка</td>
                  </tr style="border-bottom: 1px solid lightgray;">
                  <tr style="border-bottom: 1px solid lightgray;">
                  ...
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">12:30</td>
                    <td>Досуг (боулинг, кино, бассейн, playstation, игровая комната, настольный теннис, общая игра)</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">15:00</td>
                    <td>Спортивный полдник</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">16:30</td>
                    <td>Вторая тренировка</td>
                  </tr>
                  <tr style="border-bottom: 1px solid lightgray;">
                    <td width="150">18:00</td>
                    <td>Игровая комната</td>
                  </tr>
                  <tr>
                    <td width="150">19:00</td>
                    <td>Роспуск участников</td>
                  </tr>
                </table>
              </div>
            </div>
          ...
          <div class="container">
              <div class="row">
                  ...
                  <div class="col text-center mobFontSize">
                      <h3 class="desc_heading" style="height: auto !important; margin: 65px 0;">Для родителей:</h3>
                  </div>
                  <div class="w-100"></div>
                  <div class="col-md-4 d-none d-md-block">
                      <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                          <img src="<?php echo e(asset('assets/images/camp/1.svg')); ?>" style="margin-top: 15px;">

                          <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 40px !important;">Персональный менеджер</h4></b>
 <br><h4>Ведёт по организационным моментам и помогает с индивидуальными вопросами/пожеланиями</h4>
                  ...
                  <div class="col-md-4 d-none d-md-block">
                      <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                          ...
                          <b><h4 style="height: 48px;font-family: Montserrat Alternates;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 40px !important;">
                                  Фото и видео отчёт в WhatsApp</h4></b>
                          <br><h4>Ежедневно Вы будете видеть как проводит время в лагере ваш ребенок</h4>
                   ...
                   <div class="col-md-4 d-none d-md-block">
                      <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                          ...
                          <b><h4 style="height: 48px;font-family: Montserrat Alternates;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 40px !important;">
                                  Обратная связь</h4></b>
                          <br><h4>По итогам проведенного дня тренер дает обратную связь об успехах юного спортсмена</h4>
          ...
          <div class="container">
            ...
            <div class="col-12 d-sm-block d-md-none">
              <div class="row mobile-advantage-slider">
                ...
                <div class="col-12">
                  <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                    <img src="<?php echo e(asset('assets/images/camp/1.svg')); ?>" style="margin-top: 15px;">
                    <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Персональный менеджер</h4></b>
                    <br>  <p>Ведёт по организационным моментам и помогает с индивидуальными вопросами/пожеланиями</p>

                  </div>
                </div>
                <div class="col-12">
                  <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                    <img src="<?php echo e(asset('assets/images/camp/3.svg')); ?>" style="margin-top: 15px;">
                    <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Фото и видео отчёт в WhatsApp</h4></b>
                     <br> <p>Ежедневно Вы будете видеть как проводит время в лагере ваш ребенок</p>
                ...
                <div class="col-12">
                  <div class="advantage-main text-center" style="width: 100% !important; padding-left: 0 !important;">
                    <img src="{{ asset('assets/images/camp/ico_4.svg') }}" style="margin-top: 15px;">
                    <b><h4 style="height: 48px;font-size: 16px;font-weight: normal;font-stretch: normal;font-style: normal;line-height: 1.33;letter-spacing: normal;color: #303337;font-weight: 800; padding-top: 20px !important;">Обратная связь</h4></b>
                    <br>  <p>По итогам проведенного дня тренер дает обратную связь об успехах юного спортсмена</p>
            ...
            <div class="w-100"></div>
              ...
              <div class="col-12  text-center">
                  ...
                  <div class="friends_button" style="text-align: center;">
                      <button type="button" style=" width: 380px;" class="btn btn-primary" name="button" data-toggle="modal" data-animation="bounce" data-target=".bs-example-modal-lg">Записаться на экскурсию</button>
                  </div>
              </div>
          </div>
      </div>
      ...
      @include('sections.cao-locations')

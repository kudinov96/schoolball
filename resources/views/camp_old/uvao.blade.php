...
@section('content')
          ...
          <div class="firstSection">
            <div class="row">
              <div class="col-md-6 firstSectionDescription">
                <h3>Летний дневной лагерь в юго-восточном округе</h3>

                <h4 style="font-size: 26px !important;">Стадион "МВА", ул. Академика Скрябина, 23, стр 2</h4>
    ...
    color: #f44336;
    text-align: left;
                " onclick="window.open('https://yandex.ru/maps/-/CCUB6VHNDC', '_blank')">м. Кузьминки </h3>
                 <h3 class="underlineHover" style="cursor: pointer;
                 font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUB6VHNDC', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
          ...
          <div class="firstSection">
            <div class="row">
              ...
              <div class="col-12 firstSectionDescription text-center">
                <h3>Летний дневной лагерь в юго-восточном округе</h3>
                <h4>Стадион "МВА", ул. Академика Скрябина, 23, стр 2</h4>
                <h3 class="underlineHover" style="font-size: 18px; color: #f44336;"> м. Кузьминки </h3>
                <h3 class="underlineHover" style="cursor: pointer;font-size: 25px;font-weight: 600;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;color: #2a5dde;text-align: left;" onclick="window.open('https://yandex.ru/maps/-/CCUB6VHNDC', '_blank')">Построить маршрут <span style="font-size: 25px;">→</span></h3>
      ...
      <div class="secondSection d-none d-md-block">
        <div class="container">
          <div class="col-md-12 text-center">
            ...
            <h3 class="desc_heading" style="height: auto !important; margin-bottom: 65px;">Стадион МВА</h3>
          ...
          <div class="row">
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                ...
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Лучший стадион в ЮВАО</h4></b>
              </div>
            </div>
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
            ...
            <div class="col-md-3">
              <div class="advantage text-center" style="width: 100% !important; padding-left: 0 !important;">
                ...
                <b><h4 style="font-weight: 800; padding-top: 40px !important;">Пляжный футбол</h4></b>
               <br> <p style="font-size:16px;"><b>Парк Кузьминки в 5 минутах </b> <br>
                <b>Бесплатная парковка</b></p>
        ...
        <div class="container">
          <div class="row ">
            <div class="col-md-12 text-center mobSeventhSection">
              <h3 style="margin-bottom: 65px;margin-top: 30px;font-weight: bold;font-stretch: normal;font-style: normal;line-height: 1.17;letter-spacing: normal;text-align: center;color: #303337;">Стадион МВА</h3>
            </div>
                ...
                <ul class="row nav nav-tabs nav-tabs-info nav-justified" style="border-bottom: none;">
                  ...
                  <li class="col nav-item" style="padding:0 8px 0 0;">
                    <a class="nav-link groupTogler" data-toggle="tab" href="#tab-4" style="width: 115px !important;">
                      <h4 style="width: 88px !important;">Прогулки</h4>
                    </a>
                  </li>
                  <li class="col nav-item" style="padding:0 8px 0 0;">
              ...
              <div id="tab-2" class="kidsSkills tab-pane" style="height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3>Накормим</h3>
                    <p>
                      Чтобы добиться высоких спортивных результатов, важно правильно дозировать нагрузки и обеспечивать восстановление после них. На время проведения лагеря наши специалисты подготовили меню полноценного спортивного питания.
                    </p>
                  </div>
                  <div class="col-md-5">
              ...
              <div id="tab-4" class="kidsSkills tab-pane" style="height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3>Парк</h3>
                    <p>
                      ✓ Большую часть свободного времени мы проведём в парке <br>
                      ✓ Квесты <br>
                      ✓ Веревочный парк <br>
                  ...
                  <div class="col-md-5">
                    <img src="{{ asset('assets/images/camp/sl-park.png') }}" style="width: 100%; height: auto !important;">
                  </div>
                  <div class="col-md-1">
          ...
          <div class="row mobile-advantage-slider">
            ...
            <div>
              <div id="tab-4" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 90%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3 style="font-size:22px">Парк</h3>
                    <p style="font-size: 12px;">
                        ✓ Большую часть свободного времени мы проведём в парке <br>
                        ✓ Квесты <br>
                        ✓ Веревочный парк <br>
            ...
            <div>
              <div id="tab-5" class="kidsSkills tab-pane active" style="padding-top: 10px;width: 90%;margin: 25px 5% 0 5%;height: auto !important; padding-bottom: 35px;">
                <div class="row">
                  <div class="col-md-6 kidsSkillsText">
                    <h3 style="font-size:22px">КАРО 4 "ВЫСОТА"</h3>
                    <p style="font-size: 12px;">
                      ✓	ТЦ "ВЫСОТА" <br>
                      ✓	За детьми следят несколько тренеров <br>
                      ✓	Фильмы соответствуют возрастной категории
...
<?php /*
      ...
      */
      ...
      @include('sections.parents')

      @include('sections.uvao-locations')

@extends('layouts.app')
@section('title')
    <title>Футбольные сборы для детей в москве в 2023</title>
@endsection
@section('description')
    <meta property="og:description" content="“Школа мяча” проводит футбольные сборы для детей в москве и Подмосковье - научим играть в футбол вашего ребенка">
    <meta name="description" content="“Школа мяча” проводит футбольные сборы для детей в москве и Подмосковье - научим играть в футбол вашего ребенка">
...
">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h1 class="title-desc" style="margin-bottom: 32px !important;">Каталог футбольных лагерей Школы мяча</h1>
                    <h5 class="text-desc " style="font-size: 26px; ">
                        Наша футбольная школа предлагает набор специализированных событий, где ваш ребёнок получает уникальный опыт: новые навыки и мастер-классы от профессионалов, учится быть как лидером так и командным игроком.
    ...
    margin-top: 40px;">
        <div class="container">
            <div class="col-md-12 text-center">
                <h1 class="title-desc-mob" style="margin-bottom: 0px !important;">Каталог футбольных лагерей Школы мяча
                </h1>

                <h4 style=" font-size: 18px; margin-top: 12px !important; margin-bottom: 32px !important;">Наша футбольная школа предлагает набор специализированных событий, где ваш ребёнок получает уникальный опыт: новые навыки и мастер-классы от профессионалов, учится быть как лидером так и командным игроком.</h4>
            </div>
    ...
    <section class="catalog mt-5 mb-5">
        <div class="container">
            ...
            <form id="search-form">
                <div class="row  ">
                    <div class="col-md-3">
                        <h5 class="span-gr"> Месяц</h5>

                        <div class="checkselect form-control custom-select custom-select-lg mb-3 card-select mobl">
                            <div class="checkbox-container">

                                <label><input type="checkbox" name="month[]" value="05"> Май 2023</label>
                                <label><input type="checkbox" name="month[]" value="06"> Июнь 2023</label>
                                <label><input type="checkbox" name="month[]" value="07"> Июль 2023</label>
                                <label><input type="checkbox" name="month[]" value="08"> Август 2023</label>
                                <label><input type="checkbox" name="month[]" value="09"> Сентябрь 2023</label>
                                <label><input type="checkbox" name="month[]" value="10"> Октябрь 2023</label>
                                <label><input type="checkbox" name="month[]" value="11"> Ноябрь 2023</label>
                                <label><input type="checkbox" name="month[]" value="12"> Декабрь 2023</label>
                            </div>
                            <!-- Добавляем другие месяцы, если нужно -->
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="camp-type-tabs">
                            <div>
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    @if($catalog->where('type', 'выездной')->count() > 0)
    <li class="nav-item" role="presentation">
        <button name="type"  style="    width: 180px;" value="выездной" class="nav-link-catalog" id="pills-1-tab" data-toggle="pill" data-target="#pills-1" type="button" role="tab" aria-controls="pills-1" aria-selected="false">Выездной лагерь</button>
    </li>
                                    @endif

                                    @if($catalog->where('type', 'дневной')->count() > 0)

                                    <li class="nav-item" role="presentation">
        <button name="type"  style="    width: 180px;"  value="дневной" class="nav-link-catalog" id="pills-2-tab" data-toggle="pill" data-target="#pills-2" type="button" role="tab" aria-controls="pills-2" aria-selected="false">Дневной лагерь</button>
    </li>

                                    @endif


                                    @if($catalog->where('type', 'выходные')->count() > 0)


                                    <li class="nav-item" role="presentation">
        <button name="type" style="    width: 227px;"  value="выходные" class="nav-link-catalog" id="pills-3-tab" data-toggle="pill" data-target="#pills-3" type="button" role="tab" aria-controls="pills-3" aria-selected="false">Футбольные выходные</button>
    </li>
                                    @endif
                    ...
                    <div class="col-md-3">
                        <h5 class="span-gr" style="margin-top: 10px;"> Сортировать по дате проведения</h5>

<div class="seventhSection"  style="margin-top: 50px; margin-bottom: 48px;">
    <div class="container">
        <div class="mobSeventhSection col-md-12 text-center d-none d-md-block">
            <h3 class="title-desc">Место проведения лагеря</h3>
            <h5 class="text-desc " style="font-size: 18px; "> 5-й Донской проезд д. 15 стр. 7
    ...
    margin-left: -16px;">
            <h3 class="mob-title-sec" style="  ">Место проведения лагеря</h3>
            <h5 class="text-desc " style="font-size: 18px;    text-align: left !important; "> 5-й Донской проезд д. 15 стр. 7

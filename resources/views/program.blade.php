...
@section('content')
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-12 text-center">
                    <h3 class="title-desc" style="margin-bottom: 32px !important;">Каталог лагерей Школы мяча</h3>
                    <h5 class="text-desc " style="font-size: 26px; ">
                        Наша футбольная школа предлагает
                        набор специализированных лагерей, где ваш ребёнок….
    ...
    margin-top: 40px;">
        <div class="container">
            <div class="col-md-12 text-center">
                <h3 class="title-desc-mob" style="margin-bottom: 0px !important;">Каталог лагерей Школы мяча
                </h3>

                <h4 style=" font-size: 18px; margin-top: 12px !important; margin-bottom: 32px !important;">Наша футбольная школа предлагает
                    набор специализированных лагерей, где ваш ребёнок….</h4>
            </div>
    ...
    font-size: 16px;" href="{{ $camp->url }}" >{{ $camp->name }} </a>
                            ...
                            <div class="col-md-4 hidden" data-date-from="{{ $camp->date_from }}" data-date-to="{{ $camp->date_to }}"></div>

...
@section('content')
    ...
    <div class="align-item-center mt-2">
        <button class="btn btn-dark waves-effect waves-light" onclick="document.location.href = '/seasonPlayerNew';">Создать новую запись</button>
    </div>
    ...
    <tr>
        ...
        <td><a href="/season-player/{{ $season->id }}/edit">
                {{ $season->player_name }}
            </a></td>
        <td><a href="/season-player/{{ $season->id }}/edit">
                {{ $season->team_name }}

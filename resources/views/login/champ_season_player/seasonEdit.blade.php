...
@section('content')
    <form id="sendform" method="POST" enctype="multipart/form-data" action="/season-player/{{ $season->id }}/edit">
  @csrf
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
          ...
          <h4 class="mt-0 header-title">Основная информация</h4>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <div class="form-group row">
                        <label for="team_name" class="col-sm-2 col-form-label text-right">{{ __('Игрок ') }}</label>
                        <div class="col-sm-10">
                            <input id="player_name" type="text" class="form-control" name="player_name" value="{{ $season->player_name }}">
                        </div>
                    </div>

                    <div class="form-group row">
                        <label for="team_name" class="col-sm-2 col-form-label text-right">{{ __('Наименование клуба') }}</label>
                        <div class="col-sm-10">
    ...
    <form id="deleteform" method="POST" action="/season-player/{{ $season->id }}/delete">
        @csrf
    </form>

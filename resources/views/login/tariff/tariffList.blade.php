...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Таблицы тарифов</h4>
    ...
    <div class="align-item-center mt-2">
        <button class="btn btn-dark waves-effect waves-light" onclick="document.location.href = '/tariffNew';">Создать новый тариф</button>
    </div>
    ...
    <tr>
        <th scope="row"><a href="/tariff/{{ $tariff->id }}/edit">{{ $tariff->id }}</a></th>

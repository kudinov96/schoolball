...
@section('content')
    <form id="sendform" method="POST" enctype="multipart/form-data" action="{{ route('priceNew', $main) }}">
  @csrf
  <div class="row">
    <div class="col-lg-12">
      <div class="card">
          <div class="card-body">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input id="price" name="price" class="form-control" type="text"  required autocomplete="time">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <input id="duration" name="duration" class="form-control" type="text"  required autocomplete="title">
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <textarea id="desc_front" name="desc_front" class="form-control" rows="4" ></textarea>
              ...
              <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                      ...
                      <textarea id="elm1" name="desc_back"></textarea>
              ...
              <label for="name" class="col-sm-2 col-form-label text-right">{{ __('Изображение 1') }}</label>
                  <div class="col-sm-6">
              <input type="file" id="input-file-now-custom-1" name="img_front" class="dropify" data-default-file="{{ asset('assets/no_photo.jpg') }}" />
                  </div>  </div>

              <div class="form-group row">
                  <label for="name" class="col-sm-2 col-form-label text-right">{{ __('Изображение 2') }}</label>
                  <div class="col-sm-6">
                  <input type="file" id="input-file-now-custom-1" name="img_back" class="dropify" data-default-file="{{ asset('assets/no_photo.jpg') }}" />
                  </div>  </div>

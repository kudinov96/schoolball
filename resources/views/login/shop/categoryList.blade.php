...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Категории магазина</h4>
    ...
    <div class="align-item-center mt-2">
        <button class="btn btn-dark waves-effect waves-light" onclick="document.location.href = '/categoryShopCreate';">Создать новую категорию</button>
    </div>
    ...
    <table class="table">
        ...
        @foreach ($crmtable as $category)

    <tr>
        <th scope="row"><a href="/shop/{{ $category->id }}/edit">{{ $category->id }}</a></th>
        <td><a href="/shop/{{ $category->id }}/edit">
                {{ $category->name }}

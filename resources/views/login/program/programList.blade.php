...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    <h4 class="mt-0 header-title">Программы </h4>
    ...
    <div class="align-item-center mt-2">
        <button class="btn btn-dark waves-effect waves-light" onclick="document.location.href = '/programNew';">Создать</button>
    </div>
    ...
    <table class="table">
        ...
        @foreach ($crmtable as $program)

    <tr>
        <th scope="row"><a href="/program/{{ $program->id }}/edit">{{ $program->id }}</a></th>
        <td><a href="/program/{{ $program->id }}/edit">
                {{ $program->topic }}

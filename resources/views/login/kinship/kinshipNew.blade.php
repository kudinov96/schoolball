            ...
            <div class="row">
              ...
              <div class="col-8">
                <div class="form-group row" style="margin-top: 15px;"> <!-- Name -->
                  ...
                  <div class="col-md-7">
                    <input id="name" type="text" class="form-control-new" name="name" required autocomplete="name">
                  </div>
                </div>
                <div class="form-group row" style="margin-top: 15px;"> <!-- Surname -->
                  ...
                  <div class="col-md-7">
                    <input id="surname" type="text" class="form-control-new" name="surname" required autocomplete="surname">
                  </div>
                </div>
                ...
                <div class="form-group row"> <!-- DateBirth -->
                  ...
                  <div class="col-md-7">
                    <input id="date-birth" type="text" class="datepicker-here form-control-new" name="date-birth" value="">
                  </div>
                </div>
              </div>
              <div class="col-4">
                <div class="form-group row"> <!-- Image -->
                  <div style="margin: 0 auto;">
                    <img id="img-preview" src="{{ asset('assets/no_photo.jpg') }}" style="object-fit: cover; width: 200px; height: 200px; border-radius: 100px; border: solid 4px rgba(254, 195, 17, 0.5); background-color: #ffffff;"/>
                    <br/>

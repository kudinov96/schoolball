                                    ...
                                    @if (!empty($mainindex->images))
                                        @foreach(explode('|', $mainindex->images) as $index => $row)
                                            <div class="image-item" data-index="{{ $index }}">
                                                ...
                                                <br>
                                                <form method="post" action="{{ route('deletePhotoClub', [$mainindex->id]) }}">
                                                    @csrf
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <hr>
                <form id="sendform" method="POST" enctype="multipart/form-data" action="{{ route('updatePhotoClub', [$mainindex->id]) }}">
                    @csrf

@extends('layouts.app')
@section('title')
 <title>Детская футбольная школа в Москве для юных футболистов</title>
@endsection
@section('description')
...
@section('content')
    ...
    <div class="topPartsGray no-radius " style="background: #ffffff;
    margin-top: 120px;  margin-bottom: 120px;">
        <div class="container">
            <div class="row">
                <div class="col-md-12 text-center">
                    <div data-marquiz-id="6525141c152c9000257a2b38"></div>
                    <script>(function(t, p) {window.Marquiz ? Marquiz.add([t, p]) : document.addEventListener('marquizLoaded', function() {Marquiz.add([t, p])})})('Inline', {id: '6525141c152c9000257a2b38', buttonText: 'Пройти тест', bgColor: '#fec311', textColor: '#363636', rounded: true, shadow: 'rgba(254, 195, 17, 0.5)', blicked: true, buttonOnMobile: true, width: '1100', height: '600'})</script>
                </div>
            </div>
        </div>
    </div>
